...
if nargin < 5
    fRange = [80, 8000]; % default frequency range in Hz
end

numChan = 64;      % default is 128 channels
...
gt = gammatone(target,numChan,fRange,40000);
gm = gammatone(masker,numChan,fRange,40000);
