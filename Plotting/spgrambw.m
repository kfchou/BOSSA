function [t,f,b,braw,brawfilt,spec]=spgrambw(s,fs,varargin)
...
%
spec.title = 'spectrogram parameters';
...
%     fftlen = winlen;
    ...
    b=s;
    braw = s; %added by kfc. can remove.
...
brawfilt = braw*filtbankm(nfrq,fftlen,fftfs,fx(1),fx(end),fbopt)';
